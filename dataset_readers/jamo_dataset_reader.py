...
from allennlp.data.fields import (
    LabelField, ListField, TextField
)
...
@DatasetReader.register('jamo')
class JamoReader(DatasetReader):
    """
    ...
    def text_to_instance(self,
        ...
        text_fields = pad_sequence_to_length(
            sequence=text_fields,
            desired_length=self._maximum_dialogue_length,
            default_value=text_fields[0].empty_field
        )
